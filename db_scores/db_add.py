...
"""
create_table2 = """
  CREATE TABLE IF NOT EXISTS scores2 (LIKE scores);
...
sql_insert = """
INSERT INTO scores2 (id, model, langpair, testset, score, catalog, score_type, date)
...
for line in sys.stdin:
    ...
    t = (id, model, langpair, testset, score, catalog, score_type, date)
    id += 1
